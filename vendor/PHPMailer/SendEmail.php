...
class SendEmail
{
    ...
    private static $From = 'takunwang@163.com'; //发送者的邮件地址
    private static $FromName = 'takun'; //发送邮件的用户昵称
    private static $Username = 'takunwang@163.com'; //登录到邮箱的用户名
    private static $Password = 'wangjiapenghaha1'; //第三方登录的授权码，在邮箱里面设置
     ...
     */
    public static function SendEmail($title=1,$message=1,$emailAddress='wjp@kwcnet.com')
    {
        $mail = new PHPMailer();
